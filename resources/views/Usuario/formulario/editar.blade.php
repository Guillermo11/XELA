  ...
  <div class="row">
    <div class="col-md-2">
      <div class="form-group">
             ...
             {!! Form::text("fercha_hoy",null, ['required','id' => 'nombres','class'=>'form-control','placeholder'=>'Nombres*','autofocus']) !!}
       ...
       <div class="col-md-3">
         <div class="form-group">
                ...
                {!! Form::text("apellidos",null, ['required','id' => 'apellidos','class'=>'form-control','autofocus']) !!}
     ...
     <div class="col-md-2">
       <div class="form-group">
         <label  for="exampleSelect1">Dpi</label>
            {!! Form::text('dpi', null,['required','disabled','id' => 'dpi','class'=>'form-control','autofocus','placeholder'=>'DPI*','value'=>'"/^[0-9]+$/"'] ) !!}
             @if ($errors->has('dpi'))
               <span class="invalid-feedback" role="alert">
...
<div class="row">
    ...
    <div class="col-md-2">
      <div class="form-group">
        ...
        {!! Form::text('fecha_nacimiento', null,['required','id' => 'dpi','class'=>'form-control','autofocus','placeholder'=>'DPI*','value'=>'"/^[0-9]+$/"'] ) !!}
...
<div class="row">
    ...
    <div class="form-group">
      ...
      {!! Form::text('carrera_titulo',null, ['required','class'=>'form-control','placeholder'=>'arrera,Titulo o Especialidad']) !!}
